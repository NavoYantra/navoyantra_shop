              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-1">
                  <div className="flex text-amber-400">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className={`w-5 h-5 ${i < Math.floor(product.rating) ? 'fill-amber-400' : 'fill-slate-200 text-slate-200'}`} />
                    ))}
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-xl border border-slate-100 bg-slate-50 flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">{product.techStack.join(', ')}</p>
                </div>
              </div>
            </div>
          </div>
