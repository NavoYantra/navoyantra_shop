        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {CATEGORIES.map((category) => (
            <div
              ...
              className="group relative rounded-3xl overflow-hidden border border-slate-200/70  bg-slate-50/60  p-6 hover:shadow-2xl hover:border-blue-500/50 :border-blue-500/50 transition-all duration-300 cursor-pointer flex flex-col justify-between"
            >
              ...
              <div>
                ...
                <h3 className="text-xl font-bold font-heading text-slate-900  group-hover:text-blue-600 :text-blue-400 transition-colors">
                  {category.title}
                </h3>
