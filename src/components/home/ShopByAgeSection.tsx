          ...
          {ageBrackets.map((bracket) => (
            ...
            >
              ...
              <div className="mt-8 pt-4 border-t border-slate-100  flex items-center justify-between">
                ...
                <button className="px-5 py-2.5 rounded-xl bg-slate-900 text-white   font-bold text-xs group-hover:bg-blue-600 :bg-blue-500 :text-white transition-colors flex items-center space-x-2 shadow-md">
