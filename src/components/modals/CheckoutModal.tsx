            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-2">
                ...
                <button
                  ...
                  className="px-8 py-3.5 rounded-2xl bg-orange-600 hover:opacity-95 text-white font-bold text-xs shadow-xl shadow-orange-500/25 transition-transform hover:scale-105"
                >
                  Confirm & Place Order
                </button>
              </div>
