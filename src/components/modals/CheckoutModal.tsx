...
import { 
  ShoppingBag, X, CheckCircle2, ShieldCheck, MapPin, CreditCard, QrCode, Truck, ArrowRight 
} from 'lucide-react';
        ...
        <div className="p-6">
          ...
          {step === 'shipping' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="text-xs font-bold text-slate-600 dark:text-slate-400 block mb-1">Mobile Phone Number</label>
                  <input
                    type="tel"
              ...
              <div>
                <label className="text-xs font-bold text-slate-600 dark:text-slate-400 block mb-1">Flat, House No., Street Address</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-xs font-bold text-slate-600 dark:text-slate-400 block mb-1">Pincode</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs font-bold text-slate-600 dark:text-slate-400 block mb-1">City</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs font-bold text-slate-600 dark:text-slate-400 block mb-1">State</label>
                  <input
                    type="text"
          ...
          {step === 'payment' && (
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <label 
                  ...
                  className={`flex items-center justify-between p-4 rounded-2xl border cursor-pointer transition-all ${
                    paymentMethod === 'upi' ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-950/40' : 'border-slate-200 dark:border-slate-800'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <QrCode className="w-5 h-5 text-blue-600" />
                    <div>
                      <h5 className="text-xs font-bold text-slate-900 dark:text-white">UPI QR & Apps (GPay, PhonePe, Paytm)</h5>
                ...
                <label 
                  ...
                  className={`flex items-center justify-between p-4 rounded-2xl border cursor-pointer transition-all ${
                    paymentMethod === 'card' ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-950/40' : 'border-slate-200 dark:border-slate-800'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <CreditCard className="w-5 h-5 text-purple-600" />
                    <div>
                      <h5 className="text-xs font-bold text-slate-900 dark:text-white">Credit / Debit Card & NetBanking</h5>
                ...
                <label 
                  ...
                  className={`flex items-center justify-between p-4 rounded-2xl border cursor-pointer transition-all ${
                    paymentMethod === 'cod' ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-950/40' : 'border-slate-200 dark:border-slate-800'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <Truck className="w-5 h-5 text-emerald-600" />
                    <div>
                      <h5 className="text-xs font-bold text-slate-900 dark:text-white">Cash on Delivery (COD)</h5>
              ...
              {/* Order total summary */}
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800 text-xs flex justify-between font-bold">
                <span>Total Amount Payable:</span>
                <span className="text-blue-600 dark:text-blue-400 font-heading text-sm">
          ...
          {step === 'confirmation' && (
            <div className="py-8 text-center space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800 text-xs space-y-1 text-left max-w-md mx-auto">
